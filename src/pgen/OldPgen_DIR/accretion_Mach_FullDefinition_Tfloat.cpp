...
//          pmb->pscalars->r(t_index,k,j,is-i) = Teq;
          Real Tfloat = pmb->pscalars->r(t_index,k,j,is);
          pmb->pscalars->r(t_index,k,j,is-i) = Tfloat;
          ...
          if (NON_BAROTROPIC_EOS) {
            prim(IPR,k,j,is-i) = pmb->peos->PresFromRhoT(rho_new, Tfloat, r_scalar); //This one works for tau
